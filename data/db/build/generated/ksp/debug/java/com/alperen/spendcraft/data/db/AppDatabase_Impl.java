  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `transactions` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `amountMinor` INTEGER NOT NULL, `timestampUtcMillis` INTEGER NOT NULL, `note` TEXT, `categoryId` INTEGER, `isIncome` INTEGER NOT NULL)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '0ea370a68e2897ee381f9a72b4edf7b2')");
      }
    ...
    }, "0ea370a68e2897ee381f9a72b4edf7b2", "f45fdf2316c537658d9f85247f3772c2");
